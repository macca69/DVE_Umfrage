    ...
    if horizontal_flag:
        if color_scale_flag:
            fig = px.histogram(fig_data,
                       y=filter1, x='counts', color=filter2, barnorm=barnorm, text_auto=True, color_discrete_sequence=px.colors.diverging.RdYlBu,
        ...
        if color_scale_flag:
            fig = px.histogram(fig_data,
                       x=filter1, y='counts', color=filter2, barnorm=barnorm, text_auto=True, color_discrete_sequence=px.colors.diverging.RdYlBu,
                       width=1000, height=750)
        else:
            fig = px.histogram(fig_data,
