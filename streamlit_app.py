...
with col6:
    ...
    fig.update_layout(legend=dict(orientation="v", yanchor="top", y=0.0, xanchor="left", x=0),
...
with col7:
    ...
    fig2.update_layout(legend=dict(orientation="v", yanchor="top", y=0.0, xanchor="left", x=0),
